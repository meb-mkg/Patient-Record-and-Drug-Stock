			...
			<div class="sidebar-wrapper">
				<div class="logo">
					<a href="http://www.mitethiopia.com" class="simple-text">
						MIT Clinic Patient Registration and Drug Stock
					</a>
				</div>
				<ul class="nav">
					<li class="active">
						...
						<div class="card-deck">
							<div class="col-sm-2" style="font-size: 20px;">
								<div class="card">
									<div class="card-body text-center">
										...
										<a href="doctor.php" class="card-text">Doctor</a>
									</div>
									<br>
								</div> 
							</div>
							<div class="col-sm-2" style="font-size: 20px;">
								<div class="card">
									<div class="card-body text-center">
										...
										<a href="patient.php" class="card-text">Patient</a>
									</div>
									<br>
								</div> 
							</div>
							<div class="col-sm-2" style="font-size: 20px;">
								<div class="card">
									<div class="card-body text-center">
										<br>
										<i class="fa fa-user-nurse"></i><br>
										<a href="nurse.php" class="card-text">Nurse</a>
									</div>
									<br>
								</div>
							</div>
							<div class="col-sm-2" style="font-size: 20px;">
								<div class="card">
									<div class="card-body text-center">
										...
										<a href="pharmacist.php" class="card-text">Pharmacist</a>
									</div>
									<br>
								</div>
							</div>
							<div class="col-sm-2" style="font-size: 20px;">
								<div class="card">
									<div class="card-body text-center">
										...
										<a href="labaratorist.php" class="card-text">Labaratorist</a>
									</div>
									<br>
								</div>
							</div>
							<div class="col-sm-2" style="font-size: 20px;">
								<div class="card">
									<div class="card-body text-center">
										<br>
										<i class="fa fa fa-file"></i><br>
										<a href="" class="card-text">Reports</a>
									</div>
									<br>
								</div>
							</div>
